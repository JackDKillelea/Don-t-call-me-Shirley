...
def InitRegionRankingsTable(player_data):
    ...
    if player_data:
        ...
        for data in player_data:
            ...
            GetRanks(ranks, player_info, "tank", "Tank", "region")
            GetRanks(ranks, player_info, "class_tank", "Class Tank", "region")
            GetRanks(ranks, player_info, "healer", "Healer", "region")
            GetRanks(ranks, player_info, "class_healer", "Class Healer", "region")
            GetRanks(ranks, player_info, "dps", "DPS", "region")
            GetRanks(ranks, player_info, "class_dps", "Class DPS", "region")
